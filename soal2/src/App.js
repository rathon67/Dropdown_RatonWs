            ...
            <div>
                ...
                <center>          
                  <div id="judul" style={judul}>
                    <h1 style={{color:'red',fontFamiliy:'fantasy'}}>Jenjang Pendidikan</h1>        
                  </div>
                  ...
                  <div className="col">
                    {/* Dropdown Jenjang */}
                      <div class="container" style={{padding: '50px'}}>
                        <div class="dropdown ">
                        <button class="btn-lg btn-info dropdown-toggle" style={lebarmenu} data-toggle="dropdown">{this.state.namajenjang}</button>
                    ...
                    {/* Dropdown Tingkatan */}          
                      <div class="container" style={{padding: '50px'}}>
                        <div class="dropdown">
                          ...
                          <button class="btn-lg btn-warning dropdown-toggle" style={lebarmenu} data-toggle="dropdown">
